			...
			<Stack>
				<Card className={ "me-card" } id={ "me" }>
					<Card.Body>
						...
						<Card.Text>
							<p>
								Mein Name ist Nicholas Krebs und ich bin ein Informatik Lehrling im 2. Lehrjahr in
								der <a href="https://www.tfbern.ch/">Technischen Fachschule</a> in Bern. Ich
								interessiere mich sehr für Informatik und vorallem für die Webentwicklung. Ich
								programmiere gerne Webseiten sowie auch Webapps. Mehr dazu in
								den <a href={ "#references" }>Referenzen</a>
							</p>
						</Card.Text>
					</Card.Body>
				</Card>
					...
					<Card.Body>
						...
						>
							<Card className={ "skills-techs-card" } id={ "skills-techs" }>
								<Card.Body>
									<Card.Title>
										<h2><RiCodeSSlashFill /> languages </h2>
									</Card.Title>
									<Card.Text>
										<div>
											<span className={ "progress-text" }><SiHtml5 />HTML / <SiCss3 />CSS</span>
											<progress className={ "progress" } value={ "90" } max={ "100" } />
										</div>
										<div>
											<span className={ "progress-text" }><SiJavascript />JS / <SiTypescript />TS</span>
						...
						<Card.Text>
							<div>
								<ul>
									...
									<li className={ "project-text" }>
										<a href={ "https://fischlehrpfad.ch" }>fischlehrpfad.ch</a></li>
									<li className={ "project-text" }>
