...
const servicesList = () => {
	return [
		new Service( {
			...
			description: "Keine Sorge, ich werde helfen, das Problem zu lösen. Ich kenne mich mit Plattformen wie" +
		...
		new Service( {
			...
			description: "Ich erstelle für Sie die Website, die Ihre Bedürfnisse erfüllen. Auf ihren Wunsch kann" +
		...
		new Service( {
			...
			description: "Ich baue oder erweitere für Sie einen PC, mit den Spezifikationen, die er für Ihren" +
